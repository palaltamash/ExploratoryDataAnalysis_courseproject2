...
data_1999 <- subset(NEI, year == 1999 & fips == "24510")
data_2002 <- subset(NEI, year == 2002 & fips == "24510")
data_2005 <- subset(NEI, year == 2005 & fips == "24510")
data_2008 <- subset(NEI, year == 2008 & fips == "24510")
...
barplot(totalemissions, names = years, xlab = "Years", ylab = "Total Emissions",
        main = "Total emissions in Baltimore per year")
